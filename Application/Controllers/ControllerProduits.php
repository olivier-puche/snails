    ...
    public function stripe() {
        ...
        if ($this->total <= 0) {
            ...
            if ($this->verifierStock($this->panier)===true) {
                ...
                include STRIPE.'stripe/stripe-php/lib/Stripe.php';
                $stripe = new \Stripe\StripeClient("sk_test_51If0n8GAVfFRDcyqyt7RWuzbgilod4eaJWk85bXVg8xTv1nu4XqTB0qgcfdtuINm84D5Jox1VsGdhhQe2D6XcOJu005WXivVx0");
                ...
                include "./vendor/stripe/stripe-php/lib/Charge.php";
